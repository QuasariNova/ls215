...
// sufficient for her to keep the members' names and phone numbers in an
// object. Later she wants to add functionality that allows her to write this
// object to a file.
...
function isValidName(name) {
  return (/^[a-z]+ [a-z]+$/i).test(name); // digits are word characters, so are underscores
}
...
addMember('Conan _O\'Brian', '696-9696');
