...
// words. For example, the function should return "PNG" for the string
// "Portable Network Graphics". Count compound words (words connected with a
// dash) as separate words.
// Examples
